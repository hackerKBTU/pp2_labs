...
menu_png = pygame.transform.scale(pygame.image.load('mode_setting.png'), (1000, 650))
start_png = pygame.transform.scale(pygame.image.load('start.png'), (200, 50))
start_act_png = pygame.transform.scale(pygame.image.load('start_.png'), (200, 50))
pl1_png = pygame.transform.scale(pygame.image.load('1pl.png'), (200, 50))
pl2_png = pygame.transform.scale(pygame.image.load('2pl.png'), (200, 50))
pl1_act_png = pygame.transform.scale(pygame.image.load('1pl_.png'), (200, 50))
pl2_act_png = pygame.transform.scale(pygame.image.load('2pl_.png'), (200, 50))
exit_png = pygame.transform.scale(pygame.image.load('exit.png'), (200, 50))
exit_act_png = pygame.transform.scale(pygame.image.load('exit_.png'), (200, 50))
newgame_png = pygame.transform.scale(pygame.image.load('newgame.png'), (200, 50))
newgame_act_png = pygame.transform.scale(pygame.image.load('newgame_.png'), (200, 50))
bc_png = pygame.transform.scale(pygame.image.load('bc.png'), (200, 200))
rock_png = pygame.transform.scale(pygame.image.load('Rock Pile.png'), (50, 50))
rock1_png = pygame.transform.scale(pygame.image.load('Rock Pile1.png'), (50, 50))
apple_img = pygame.transform.scale(pygame.image.load('apple.png'), (25, 25))
ez_img = pygame.transform.scale(pygame.image.load('ez.png'), (400, 80))
normal_img = pygame.transform.scale(pygame.image.load('norm.png'), (400, 80))
hard_img = pygame.transform.scale(pygame.image.load('hard.png'), (400, 80))
ez_act_img = pygame.transform.scale(pygame.image.load('ez_.png'), (400, 80))
normal_act_img = pygame.transform.scale(pygame.image.load('norm_.png'), (400, 80))
hard_act_img = pygame.transform.scale(pygame.image.load('hard_.png'), (400, 80))
mode_img = pygame.transform.scale(pygame.image.load('mode.png'), (120, 20))
single_img = pygame.transform.scale(pygame.image.load('single.png'), (150, 25))
twoplayer_img = pygame.transform.scale(pygame.image.load('2player.png'), (150, 20))
gamelvl_img = pygame.transform.scale(pygame.image.load('gamelvl.png'), (150, 35))
gamelvl_ez_img = pygame.transform.scale(pygame.image.load('ezzz.png'), (70, 20))
gamelvl_norm_img = pygame.transform.scale(pygame.image.load('normal.png'), (100, 20))
gamelvl_hard_img = pygame.transform.scale(pygame.image.load('hardcore.png'), (100, 20))
score_img = pygame.transform.scale(pygame.image.load('score.png'), (100, 20))
scores_img = pygame.transform.scale(pygame.image.load('scores.png'), (100, 20))
player1_img = pygame.transform.scale(pygame.image.load('player1.png'), (100, 20))
player2_img = pygame.transform.scale(pygame.image.load('player2.png'), (100, 20))
dead_img = pygame.transform.scale(pygame.image.load('dead.png'), (50, 20))
save_img = pygame.transform.scale(pygame.image.load('save&quit.png'), (150, 35))


def main_menu():
    global game_started, start_btn, pl1_btn, pl2_btn, exit_btn, menu, newgame_btn
    pygame.mixer_music.load('gta.mp3')
